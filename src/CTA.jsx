          ...
          <div className="container mx-auto space-y-8 px-4 py-16 lg:px-8 lg:py-32 xl:max-w-7xl">
            ...
            <div className="text-center">
              <h2 className="mb-4 text-4xl font-black text-black dark:text-white">
                ...
                <span className="text-[#f7971e] dark:text-[#ffd200]">
              ...
              <h3 className="mx-auto text-xl font-medium leading-relaxed text-gray-700 lg:w-2/3 dark:text-gray-300">
                Follow us on Instagram and LinkedIn to be the first to know when Hive is available. Start spelling as soon as we launch!
              </h3>
            </div>
            {/* END Heading */}
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-center sm:gap-3">
              <a
                href="https://www.instagram.com/hive_spelling/" // Replace with your Instagram URL
              ...
              <a
                href="https://www.linkedin.com/company/hive-spelling/" // Replace with your LinkedIn URL
